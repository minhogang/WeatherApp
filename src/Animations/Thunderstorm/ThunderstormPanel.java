...
import Rain.Rain;
import Rain.RainSplash;

public class ThunderstormPanel extends JPanel
{
	...
	public ThunderstormPanel(int width, int height)
	{
	...
	public void paint(Graphics g)
	{
		...
		{
			int randomX = (int) (Math.random() * (this.getWidth()));
			int randomV = (int) (Math.random() * 6); 
			Thunderstorm thunderstorm = new Thunderstorm(randomX, randomV);
			thunderstorm.paint(g);
		}
		counter++;
	}
